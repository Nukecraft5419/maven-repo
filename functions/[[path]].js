/**
 * Cloudflare Pages Function for Maven Repository & UI
 * Intercepts requests, proxies raw content from GitHub, strips sandbox headers,
 * and handles custom MIME types for Maven/Gradle clients.
 */
...
export async function onRequest(context) {
  ...
  const response = await fetch(targetUrl, {
    headers: {
      "User-Agent": "Nukecraft5419-Pages-Function",
    },
  });
